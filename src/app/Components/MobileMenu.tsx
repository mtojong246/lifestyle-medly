...
export default function MobileMenu({isOpen, toggleOpen} : {isOpen: boolean, toggleOpen: (e:MouseEvent<HTMLButtonElement>) => void}) {
    ...
    return (
        <div className={`w-full pt-8 pb-16 flex flex-col gap-16 md:hidden text-center text-xl text-charcoal menu-closed ${isOpen ? 'menu-open' : ''}`}>
            ...
            <div className='w-full'>
                ...
                <button className='block md:hidden mt-8 mx-auto' onClick={(e:any) => {toggleOpen(e); router.push('/Blog')}}>Blog</button>
            </div>
