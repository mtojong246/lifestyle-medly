...
export default function Steps() {
    ...
    <div className='w-full text-charcoal bg-vanilla' id='how-it-works'>
      <div className='max-w-[1400px] px-10 py-[80px] sm:py-[100px] mx-auto my-0 text-center' >
        ...
        <p className='text-[40px] sm:text-[54px] font-bold mb-5'>A weight loss program that is seamless, empowering, and result-driven.</p>
        ...
        <p className='text-xl max-w-[600px] mx-auto mt-[80px] mb-[40px]'>At Lifestyle Medly, we're not selling a dream – we are helping you curate a lifestyle guided by principles of medicine and healthy living. </p>
