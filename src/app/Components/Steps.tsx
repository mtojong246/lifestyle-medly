...
export default function Steps() {
    ...
    <div className='w-full text-charcoal bg-vanilla' id='how-it-works'>
      <div className='max-w-[1400px] px-10 py-[100px] mx-auto my-0 text-center' >
        <AnimationOnScroll animateIn="animate__heartBeat" animateOnce={true} ><img src='/heart-rate.png' className='h-20 w-20 mb-5 mx-auto my-0 ' /></AnimationOnScroll>
        ...
        <div className='w-full flex justify-between items-stretch mt-[120px] flex-col md:flex-row gap-24 md:gap-0'>
          ...
          <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce={true} className='border-4 border-charcoal rounded-md p-[30px] flex-grow relative max-w-[100%] md:max-w-[32%]'>
          ...
          <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce={true} delay={100} className='border-4 border-charcoal rounded-md p-[30px] flex-grow relative max-w-[100%] md:max-w-[32%]'>
            <div className='absolute w-full top-[-55px] left-0 flex justify-center'>
              <div className='bg-maize flex justify-center items-center rounded-full w-[100px] h-[100px]'>
                <img src='/pill.png' />
              </div>
          ...
          <AnimationOnScroll animateIn="animate__fadeInUp" animateOnce={true} delay={200} className='border-4 border-charcoal rounded-md p-[30px] flex-grow relative max-w-[100%] md:max-w-[32%]'>
            <div className='absolute w-full top-[-55px] left-0 flex justify-center'>
              <div className='bg-maize flex justify-center items-center rounded-full w-[100px] h-[100px]'>
                <img src='/body.png' />
              </div>
