...
export default function Confirmation({newUser, setNewUser}: {newUser: UserType, setNewUser: Dispatch<SetStateAction<UserType>>}) {
    return (
        <>
            <p className='text-[28px] sm:text-[36px] mb-8 sm:mb-5'><span className='text-maize'>Thank you</span> for taking the quiz!</p>
            <p className='text-[48px] mb-10 sm:mb-5'>Welcome to the start of your weight loss journey!</p>
