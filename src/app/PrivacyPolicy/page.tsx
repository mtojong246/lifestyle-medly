    ...
    return (
        <div className='w-full pt-10 pb-20 px-10'>
            <div className='max-w-[600px] mx-auto text-charcoal'>
                <span className="inline-block mb-10"><Link href='/' className='text-maize'>Home</Link> / Privacy Policy</span>
                <p className='text-[28px] font-semibold mb-5'>Lifestyle Medly LLC Privacy Policy</p>
                <p className='mb-5'>Effective January 29, 2024</p>
                <p className='mb-5'>Last Updated: January 29, 2024</p>

                <p className='mb-5'>Lifestyle Medly LLC ("Lifestyle Medly," "we," "us" or "our") is committed to respecting your privacy and protecting your Personal Data and other sensitive information in connection with your use and access of the Lifestyle Medly website, including any or our associated websites, mobile applications, communication types made available to you by us (“Website”).</p>
                <p className='mb-5'>This Lifestyle Medly Privacy  Policy (“Privacy Policy”) will tell you how Lifestyle Medly collects, stores, uses, shares, and processes the Personal Data and other sensitive information we collect about you (“User” or “you”) through your access and use of the Website and Services offered through your use and access of the Website. Lifestyle Medly’s <Link href='/TermsOfService'>Terms of Service</Link>, including the definition of “Services” is incorporated herein by reference.</p>
                <p className='mb-5'>By accessing or using our Website and Services (as defined below), you acknowledge that you have read and agree to this Privacy Policy, and that you consent to our collection, use, and sharing of your Information as described herein.</p>  
                ...
                <p className='mb-5 font-semibold underline'>Information about Interest-Based Advertisements:</p>
                <p className='mb-5'>We may serve advertisements, and also allow third-party ad networks, including third-party ad servers, ad agencies, ad technology vendors, and research firms, to serve advertisements through the Website and Services. These advertisements may be targeted to users who fit certain general profile categories or display certain preferences or behaviors (“Interest-Based Ads”). Information for Interest-Based Ads (including Personal Data) may be provided to us by you or derived from the usage patterns of particular users on the Website and Services and/or services of third parties. Such information may be gathered through tracking users’ activities across time and unaffiliated properties, including when you leave the Website and Services. To accomplish this, we or our service providers may deliver Cookies, including a file (known as a “web beacon”) from an ad network to you through the Website and Services. Web beacons allow ad networks to provide anonymized, aggregated auditing, research, and reporting for us and for advertisers. Web beacons also enable ad networks to serve targeted advertisements to you when you visit other websites. Web beacons allow ad networks to view, edit or set their own Cookies on your browser, just as if you had requested a web page from their site.</p>

                <p className='mb-5 font-semibold underline'>Social Media</p>
                <p className='mb-5'>Lifestyle Medly may provide the option for individuals to participate in polling, messaging, and posting activities, including through social media channels. Lifestyle Medly is not responsible for the information collection, use, disclosure, or security policies or practices of other organizations, such as Facebook, Apple, Google, Microsoft, RIM, or any other social media platform provider, operating system provider, wireless service provider, or device manufacturer, including with respect to any Personal Data you disclose to other organizations through or in connection with our social media pages. Additionally, Lifestyle Medly may monitor social media channels for mentions of our brand, competitors, and products, which gives Lifestyle Medly an opportunity to track, analyze, and respond to conversations about us on social media.</p>

                <p className='mb-5 font-semibold underline'>Third Party Sites</p>
                <p className='mb-5'>The Lifestyle Medly Website and Services may feature links to third-party websites ("Third-Party Site(s)"). These Third-Party Sites are not owned or controlled by us, and we are not responsible for the privacy practices of such Third-Party Sites. We encourage you to be aware when you leave the Lifestyle Medly Website. If you choose to link to a Third-Party Site, you should read the privacy policy, statement, or policy of that website to understand how that Third-Party Site collects and uses Personal Data. This Privacy Policy does not apply to any information collected by Third-Party Sites.</p>



                <p className='mb-5 font-semibold underline'>How Long Do We Retain Your Personal Data?</p>
                <p className='mb-5'>We intend to keep your Personal Data and Information accurate and up-to-date and retain it for the period necessary to fulfill the legitimate business purposes or uses outlined in this Privacy Policy (i.e., as long as you have an open account with us or as otherwise necessary to provide you with our Services), unless a longer retention period is required or allowed by applicable data protection law or regulation or to otherwise fulfill a legal obligation. In addition, Information about you may be retained for a longer period of time to resolve disputes or collect fees owed to us, or as otherwise advisable, permitted, or required by applicable law, rule, or regulation. Precisely how long we need to keep your Personal Data and Information depends on the purpose for which we collect it, and therefore there is no standard retention period. Thus, the retention period may vary depending on the circumstances. For other legal reasons, e.g., in the context of legal claims, we may need to hold Personal Data and Information beyond the term required to meet the defined purpose for which they were collected in the first place. However, in these cases, we will no longer actively process the Personal Data for the originally specified purpose. We also retain Information in an anonymous, deidentified form which would not identify you personally for archival and research purposes. In general, we do not retain the Information collected on the Lifestyle Medly website for longer than five (5) years unless we have a need to retain it for legal or regulatory purposes.</p>

                <p className='mb-5 font-semibold underline'>How Do We Protect Your Personal Data?</p>
                <p className='mb-5'>Lifestyle Medly maintains a comprehensive data security program, including commercially reasonable administrative, physical, and technological security measures, to protect your Personal Data and Information and to guard against unauthorized access to your Personal Data and Information or against the unauthorized alteration, disclosure, destruction, and/or loss of such data. In deciding what level of security is appropriate, Lifestyle Medly will take into account the nature of the Personal Data and Information in question and the harm that might result from its unauthorized use, disclosure, or loss.</p>
                <p className='mb-5'>Although we take reasonable precautions to protect the Information and Personal Data we collect on the Lifestyle Medly Website and Services and store in our databases, no data transmission over the Internet can be guaranteed to be 100% secure.</p>

                <p className='mb-5 font-semibold underline'>Children</p>
                ...
                <p className='mb-5 font-semibold underline'>Special Notice Regarding International Personal Data Laws</p>
                <p className='mb-5'>Lifestyle Medly LLC is a US-based limited liability company, with an office in East Windsor, New Jersey. Lifestyle Medly does not transact business outside the United States and its Territories and thus does not gather, store or process Personal Data from ex-US citizens. Lifestyle Medly uses web servers and stores data in the United States. We may transfer your Personal Data to our service providers and others located in the United States for the purposes described in this Privacy Policy. However, it is acknowledged that this Website may be accessed by individuals residing outside the United States and its Territories and different countries have different privacy laws and requirements, and some provide less or more stringent legal protection for your Personal Data than others. Please know, however, that no matter where your Personal Data is collected or processed, if it was collected through a Lifestyle Medly Website, we will ensure that it is protected by the terms of this Privacy Policy and any privacy Policies or click-through agreements that apply to you.</p>
                ...
                <p className='mb-5'>If you have any questions or concerns about this Privacy Policy or our use of your Personal Data and Information, please email us at support@lifestylemedly.com.</p>
