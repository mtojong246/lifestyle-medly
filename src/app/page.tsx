...
export default function Home() {
  ...
  return (
    ...
    <div className='w-full text-charcoal'>
      <div className='max-w-[900px] lg:max-w-[1400px] px-10 py-[80px] sm:py-[100px] flex flex-col md:flex-row justify-between items-center flex-wrap mx-auto my-0 gap-10 md:gap-0'>
        <div className='w-full md:w-[50%]'>
          <p className='text-[55px] sm:text-[64px] leading-[5rem] font-bold fade-left'>START Your Weight Loss Journey Now!</p>
