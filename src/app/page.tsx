...
export default function Home() {
  ...
  return (
    ...
    <div className='w-full text-charcoal'>
      <div className='max-w-[900px] lg:max-w-[1400px] px-10 pt-[20px] pb-[40px] sm:pt-[100px] sm:pb-[100px] flex flex-col md:flex-row justify-between items-center flex-wrap mx-auto my-0 gap-10 md:gap-0'>
